export const MODES = {
  'video-new': {
    ...
    fields: [
      { id: 'cinematography', label: 'Cinematografia', hint: 'Ângulo e movimento da câmera', placeholder: 'Ex: Medium shot', type: 'text', suggestions: [{ label: 'Plano Aberto', value: 'Wide Shot' }, { label: 'Close-up', value: 'Close-up' }, { label: 'Visão em 1ª Pessoa', value: 'POV Shot' }, { label: 'Vista Aérea', value: 'Aerial View' }, { label: 'Câmera em Movimento', value: 'Tracking Shot' }] },
      { id: 'subject', label: 'Sujeito/Personagem', hint: 'Quem ou o que aparece na cena', placeholder: 'Ex: Um astronauta', type: 'text', suggestions: [{ label: 'Um robô', value: 'A robot' }, { label: 'Uma mulher', value: 'A woman' }, { label: 'Um dragão', value: 'A dragon' }] },
      { id: 'action', label: 'Ação', hint: 'O que o sujeito está fazendo', placeholder: 'Ex: caminhando', type: 'text', suggestions: [{ label: 'correndo', value: 'running' }, { label: 'dançando', value: 'dancing' }, { label: 'flutuando', value: 'floating' }] },
      { id: 'context', label: 'Contexto/Cenário', hint: 'Onde a cena se passa', placeholder: 'Ex: em uma floresta', type: 'text', suggestions: [{ label: 'em Marte', value: 'on Mars' }, { label: 'cidade cyberpunk', value: 'in a cyberpunk city' }, { label: 'embaixo d\'água', value: 'underwater' }] },
      { id: 'style_ambiance', label: 'Estilo & Ambiance', hint: 'Iluminação, cores e clima', placeholder: 'Ex: Iluminação cinematográfica', type: 'textarea', suggestions: [{ label: 'Cinematográfico', value: 'Cinematic' }, { label: 'Atmosférico', value: 'Moody' }, { label: 'Neon Noir', value: 'Neon Noir' }, { label: 'Hora Dourada', value: 'Golden Hour' }] }
    ]
  },
  'video-from-img': {
    id: 'video-from-img',
    ...
    fields: [
      { id: 'motion_sound', label: 'Movimento & Som', hint: 'Câmera e efeitos sonoros', placeholder: 'Ex: movimento de câmera', type: 'text', suggestions: [{ label: 'Panorâmica Lenta Direita', value: 'Slow Pan Right' }, { label: 'Dolly Zoom', value: 'Dolly Zoom' }, { label: 'Som de Trovão', value: 'SFX: Thunder cracks' }] },
      { id: 'action', label: 'Ação Adicional', hint: 'O que deve se mover na imagem', placeholder: 'Ex: nuvens se movem', type: 'textarea', suggestions: [{ label: 'cabelo ao vento', value: 'hair blowing in the wind' }, { label: 'mudança de luz', value: 'cinematic lighting shift' }] }
    ]
  },
  'photo-new': {
    id: 'photo-new',
