export const MODES = {
  ...
  'photo-new': {
    ...
    fields: [
      { id: 'subject', label: 'Sujeito', hint: 'O elemento principal da imagem', placeholder: 'Ex: Cyberpunk Warrior', type: 'text', suggestions: ['Cyberpunk Warrior', 'Forest Spirit', 'Vintage Car', 'Robotic Owl', 'Mystical Shaman', 'Futuristic Skyscraper', 'Bioluminescent Jellyfish', 'Samurai Cat', 'Victorian Explorer', 'Alien Botanist', 'Steampunk Clockmaker', 'Cosmic Dragon'] },
      { id: 'action', label: 'Ação', hint: 'O que está acontecendo', placeholder: 'Ex: posando', type: 'text', suggestions: ['staring at camera', 'dissolving into smoke', 'levitating above a lake', 'casting a glowing spell', 'repairing a golden clock', 'wandering through a neon market', 'playing a transparent violin', 'merging with digital code', 'resting in a field of glass flowers'] },
      { id: 'context', label: 'Local', hint: 'Cenário da fotografia', placeholder: 'Ex: estúdio', type: 'text', suggestions: ['Abstract Space', 'Abandoned Cathedral', 'Cyberpunk rooftop at rain', 'Bioluminescent underwater cave', 'Floating islands in the clouds', 'Library made of light', 'Ancient ruins on a desert planet', 'Victorian laboratory', 'Enchanted mirror room'] },
      { id: 'composition', label: 'Composição', hint: 'Organização visual (ex: Macro)', placeholder: 'Ex: Close-up', type: 'text', suggestions: ['Macro Shot', 'Rule of Thirds', 'Symmetrical', 'Bird\'s Eye View', 'Worm\'s Eye View', 'Dutch Angle', 'Extreme Close-up', 'Silhouette against the moon', 'Long exposure motion blur', 'Cinematic Wide Shot'] },
      { id: 'style', label: 'Estilo', hint: 'Visual artístico ou técnico', placeholder: 'Ex: Fotografia de revista', type: 'textarea', suggestions: ['The Simpsons cartoon style', 'Disney animation style', 'Rick and Morty style', 'Adventure Time style', 'Futurama art style', 'Game of Thrones aesthetic', 'Studio Ghibli style', 'Cyberpunk aesthetic', 'South Park style', 'Dragon Ball Z style', 'Marvel Comics style', 'GTA V style', 'National Geographic photography', 'Kodak Portra 400 film look', 'Hyper-realistic 8k octane render', 'Biomechanical H.R. Giger style', 'Surrealist digital art', 'Vaporwave aesthetics', 'Glitch art', 'Double exposure', 'Impressionist oil painting', 'Anamorphic lens flare', 'Studio portrait lighting', 'Macro photography details', 'Oil Painting', '3D Render', 'Pencil Sketch'] }
    ]
  },
  'photo-transform': {
    id: 'photo-transform',
